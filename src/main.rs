...
fn main() -> Result<(), String> {
    ...
    let planets = vec![
        Planet { note: Note::Mercury, bpm: rotation_around_sun_days::MERCURY_ORIGINAL_BPM, orbit_radius: 50, color: sdl2::pixels::Color::GREY },
        Planet { note: Note::Venus,   bpm: rotation_around_sun_days::VENUS_ORIGINAL_BPM,   orbit_radius: 75, color: sdl2::pixels::Color::RGB(255, 165, 0) },
        Planet { note: Note::Earth,   bpm: rotation_around_sun_days::EARTH_ORIGINAL_BPM,   orbit_radius: 100, color: sdl2::pixels::Color::RGB(0, 0, 255) },
        Planet { note: Note::Mars,    bpm: rotation_around_sun_days::MARS_ORIGINAL_BPM,    orbit_radius: 125, color: sdl2::pixels::Color::RGB(255, 100, 0) },
        Planet { note: Note::Jupiter, bpm: rotation_around_sun_days::JUPITER_ORIGINAL_BPM, orbit_radius: 150, color: sdl2::pixels::Color::RGB(218, 165, 200) },
        Planet { note: Note::Saturn,  bpm: rotation_around_sun_days::SATURN_ORIGINAL_BPM,  orbit_radius: 175, color: sdl2::pixels::Color::RGB(210, 180, 140) },
        Planet { note: Note::Uranus,  bpm: rotation_around_sun_days::URANUS_ORIGINAL_BPM,  orbit_radius: 200, color: sdl2::pixels::Color::RGB(0, 255, 255) },
        Planet { note: Note::Neptune, bpm: rotation_around_sun_days::NEPTUNE_ORIGINAL_BPM, orbit_radius: 225, color: sdl2::pixels::Color::RGB(0, 0, 139) },
        Planet { note: Note::Pluto,   bpm: rotation_around_sun_days::PLUTO_ORIGINAL_BPM,   orbit_radius: 250, color: sdl2::pixels::Color::RGB(128, 128, 128) },
    ];
    ...
    'running: loop {
        ...
        if flash_count == 9 && !first_time { // all planet orbited the same time
            first_time = true;
